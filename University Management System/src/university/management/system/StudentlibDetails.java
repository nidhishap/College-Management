...
public class StudentlibDetails extends JFrame implements ActionListener{
    ...
    public void student() {
        try {
            conn con = new conn();
            String sql = "select * from studentlib";
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            conn con = new conn();
            if( ae.getSource() == b1){
                String sql = "select * from studentlib where concat(name, student_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
		...
		st.close();
            ...
            if(ae.getSource() == b2){
                String sql = "delete from studentlib where name = '" + search.getText() + "'";
		PreparedStatement st = con.c.prepareStatement(sql);
