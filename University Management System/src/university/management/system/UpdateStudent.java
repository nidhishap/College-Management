...
//if u enter the roll no. all other details will be fetched
import java.awt.*;
import java.sql.*;
import javax.swing.*;
...
class UpdateStudent implements ActionListener{
    ...
    UpdateStudent(){;
        ...
        id15.setLayout(null);
        ImageIcon img = new ImageIcon(ClassLoader.getSystemResource("university/management/system/icons/class.jpg"));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b2){
            try{
                conn con = new conn();
                String str = "select * from student where rollno = '"+t12.getText()+"'"; //gets roll no.
                ...
                if(rs.next()){
                    ...
                    t1.setText(rs.getString(1)); //sets value in 1st column
