...
public class AddStudentlib extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                try{
                conn con = new conn();
                String sql = "insert into studentlib(student_id, name, father, course, branch, year, semester) values(?, ?, ?, ?, ?, ?, ?)";
